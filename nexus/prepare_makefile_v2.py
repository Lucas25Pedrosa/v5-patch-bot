...
s = s.replace(
    ...
    "Nexus_FILES = EnhancerTweak.m WordmarkActivation.m Translation.m HideButton11.m IconsTweak.m IconsPicker.m CacheTweak.m OLEDTweak.m NexusSettings.m NexusAvatarFix.m",
)
