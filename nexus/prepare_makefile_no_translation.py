...
for name in ("NexusAvatarFix.m", "NexusVersion102.m"):
    shutil.copyfile(root / name, out.parent / name)
...
s = s.replace(
    ...
    "Nexus_FILES = EnhancerTweak.m WordmarkActivation.m HideButton11.m IconsTweak.m IconsPicker.m CacheTweak.m OLEDTweak.m NexusSettings.m NexusAvatarFix.m NexusVersion102.m",
)
